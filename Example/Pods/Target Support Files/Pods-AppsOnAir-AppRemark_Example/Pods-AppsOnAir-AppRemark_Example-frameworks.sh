...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AppsOnAir-AppRemark/AppsOnAir_AppRemark.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppsOnAir-Core/AppsOnAir_Core.framework"
