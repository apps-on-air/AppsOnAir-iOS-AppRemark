    ...
    class AdditionalDeviceInfo {
        ...
        static private func fetchMicroPermission(_ status: AVAudioSession.RecordPermission)
            -> String
        {
            switch status {
        ...
        static private func createPermission(
            infoPlistKey: String,
            isEnable: String,
            permissionValue: String? = nil
        ) -> [String: String] {
            return [
        ...
        static func permissionsInfo() -> [String: String] {
            ...
            let usageKeys = plist.keys.filter {
                $0.contains("UsageDescription") || $0.contains("UIBackgroundModes")
            }
            for type in usageKeys {
                ...
                case type.contains("Location"):
                    lsPermissionsInfo = createPermission(
                        ...
                        isEnable: fetchLocationPermission())

                case type.contains("UIBackgroundModes"):
                    lsPermissionsInfo = createPermission(
                        infoPlistKey: "UIBackgroundModes", isEnable: "authorized",
                        permissionValue: fetchBackgroundModes())
    ...
    private class DeviceUID {
        ...
        private static func updateValue(
            _ value: String, forKeychainKey key: String, service: String
        ) -> OSStatus {
